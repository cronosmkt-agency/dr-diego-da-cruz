...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dr. Diego da Cruz Silva — Nefrologia & Clínica Geral | Centro Profissional" },
      { name: "description", content: "Especialista em saúde renal, cálculo renal, prevenção de diálise e check-up clínico geral no Centro Profissional na Várzea, Teresópolis." },
      { property: "og:title", content: "Dr. Diego da Cruz Silva — Nefrologista & Clínico Geral" },
      { property: "og:description", content: "Cuidado especializado com a saúde dos seus rins e acompanhamento clínico com empatia." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/svg+xml", href: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='25' fill='#0f2942'/><text x='50%' y='55%' text-anchor='middle' dominant-baseline='middle' fill='white' font-family='sans-serif' font-weight='800' font-size='40'>DCS</text></svg>" },
